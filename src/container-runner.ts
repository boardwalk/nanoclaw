 ...
 * Spawns agent execution in Podman containers and handles IPC
 */
...
function buildVolumeMounts(
  ...
  // Bypasses container build cache for code changes.
...
function buildContainerArgs(mounts: VolumeMount[], containerName: string): string[] {
  ...
  // Podman/Docker: --mount for readonly, -v for read-write
...
export async function runContainerAgent(
  ...
  return new Promise((resolve) => {
    ...
    // Write input and close stdin (container doesn't flush pipe without EOF)
